...
describe('N3Store', function() {
  ...
  describe('An N3Store with 5 elements', function() {
    ...
    describe('when searched without parameters', function() {
      it('should return all items in the default graph', shouldIncludeAll(store.find(), ['s1', 'p1', 'o1'], ['s1', 'p1', 'o2'], ['s1', 'p2', 'o2'], ['s2', 'p1', 'o1']));
    });
    describe('when searched with an existing subject parameter', function() {
      it('should return all items with this subject in the default graph', shouldIncludeAll(store.find('s1', null, null), ['s1', 'p1', 'o1'], ['s1', 'p1', 'o2'], ['s1', 'p2', 'o2']));
    });
    ...
    describe('when searched with an existing predicate parameter', function() {
      it('should return all items with this predicate in the default graph', shouldIncludeAll(store.find(null, 'p1', null), ['s1', 'p1', 'o1'], ['s1', 'p1', 'o2'], ['s2', 'p1', 'o1']));
    });
    ...
    describe('when searched with an existing object parameter', function() {
      it('should return all items with this object in the default graph', shouldIncludeAll(store.find(null, null, 'o1'), ['s1', 'p1', 'o1'], ['s2', 'p1', 'o1']));
    });
    ...
    describe('when searched with existing subject and predicate parameters', function() {
      it('should return all items with this subject and predicate in the default graph', shouldIncludeAll(store.find('s1', 'p1', null), ['s1', 'p1', 'o1'], ['s1', 'p1', 'o2']));
    });
    ...
    describe('when searched with existing subject and object parameters', function() {
      it('should return all items with this subject and object in the default graph', shouldIncludeAll(store.find('s1', null, 'o2'), ['s1', 'p1', 'o2'], ['s1', 'p2', 'o2']));
    });
    ...
    describe('when searched with existing predicate and object parameters', function() {
      it('should return all items with this predicate and object in the default graph', shouldIncludeAll(store.find(null, 'p1', 'o1'), ['s1', 'p1', 'o1'], ['s2', 'p1', 'o1']));
    });
    ...
    describe('when searched with existing subject, predicate, and object parameters', function() {
      it('should return all items with this subject, predicate, and object in the default graph', shouldIncludeAll(store.find('s1', 'p1', 'o1'), ['s1', 'p1', 'o1']));
    });
    ...
    describe('when searched with an existing non-default graph parameter', function() {
      it('should return all items in that graph', shouldIncludeAll(store.find(null, null, null, 'c4'), ['s1', 'p2', 'o3', 'c4']));
    });
    ...
    describe('when trying to remove a triple with a non-existing subject', function() {
      before(function() {
        store.removeTriple('s0', 'p1', 'o1');
      });
      it('should still have size 5', function() {
        store.size.should.eql(5);
      });
    });
    describe('when trying to remove a triple with a non-existing predicate', function() {
      before(function() {
        store.removeTriple('s1', 'p0', 'o1');
      });
      it('should still have size 5', function() {
        store.size.should.eql(5);
      });
    ...
    describe('when trying to remove an incomplete triple', function() {
      before(function() {
        store.removeTriple('s1', null, null);
      });
      it('should still have size 5', function() {
        store.size.should.eql(5);
      });
    ...
    describe('when trying to remove a triple with a non-existing graph', function() {
      before(function() {
        store.removeTriple('s1', 'p1', 'o1', 'c0');
      });
      it('should still have size 5', function() {
        store.size.should.eql(5);
      });
    ...
    describe('when removing an existing triple', function() {
      before(function() {
        store.removeTriple('s1', 'p1', 'o1');
      });
      it('should have size 4', function() {
        store.size.should.eql(4);
      });
      it('should not contain that triple anymore', shouldIncludeAll(function() {
        return store.find();
      }, ['s1', 'p1', 'o2'], ['s1', 'p2', 'o2'], ['s2', 'p1', 'o1']));
    });
    describe('when removing an existing triple from a non-default graph', function() {
      before(function() {
        store.removeTriple('s1', 'p2', 'o3', 'c4');
      });
      it('should have size 3', function() {
        store.size.should.eql(3);
      });
      itShouldBeEmpty(function() {
        return store.find(null, null, null, 'c4');
      });
    });
    describe('when removing multiple triples', function() {
      ...
      it('should not contain those triples anymore', shouldIncludeAll(function() {
        return store.find();
      }, ['s1', 'p1', 'o2']));
    });
    describe('when adding and removing a triple', function() {
      ...
      it('should have an unchanged size', function() {
        store.size.should.eql(1);
      });
    });
  });
  describe('An N3Store initialized with prefixes', function() {
    var store = new N3Store([{
      subject: 'http://foo.org/#s1',
      predicate: 'http://bar.org/p1',
      object: 'http://foo.org/#o1'
    }, {
      subject: 'http://foo.org/#s1',
      predicate: 'http://bar.org/p2',
      object: 'http://foo.org/#o1'
    }, {
      subject: 'http://foo.org/#s2',
      predicate: 'http://bar.org/p1',
      object: 'http://foo.org/#o2'
    }, {
      subject: 'http://foo.org/#s3',
      predicate: 'http://bar.org/p3',
      object: '"a"^^http://foo.org/#t1'
    }, {
      subject: 'http://foo.org/#s1',
      predicate: 'http://bar.org/p1',
      object: 'http://foo.org/#o1',
      graph: 'http://graphs.org/#g1'
    }], {prefixes: {
        a: 'http://foo.org/#',
        b: 'http://bar.org/',
        g: 'http://graphs.org/#'
    ...
    describe('should allow to query subjects with prefixes', function() {
      it('should return all triples with that subject', shouldIncludeAll(store.find('a:s1', null, null), ['http://foo.org/#s1', 'http://bar.org/p1', 'http://foo.org/#o1'], ['http://foo.org/#s1', 'http://bar.org/p2', 'http://foo.org/#o1']));
    });
    describe('should allow to query predicates with prefixes', function() {
      it('should return all triples with that predicate', shouldIncludeAll(store.find(null, 'b:p1', null), ['http://foo.org/#s1', 'http://bar.org/p1', 'http://foo.org/#o1'], ['http://foo.org/#s2', 'http://bar.org/p1', 'http://foo.org/#o2']));
    });
    describe('should allow to query objects with prefixes', function() {
      it('should return all triples with that object', shouldIncludeAll(store.find(null, null, 'a:o1'), ['http://foo.org/#s1', 'http://bar.org/p1', 'http://foo.org/#o1'], ['http://foo.org/#s1', 'http://bar.org/p2', 'http://foo.org/#o1']));
    });
    describe('should allow to query graphs with prefixes', function() {
      it('should return all triples with that graph', shouldIncludeAll(store.find(null, null, null, 'http://graphs.org/#g1'), ['http://foo.org/#s1', 'http://bar.org/p1', 'http://foo.org/#o1', 'http://graphs.org/#g1']));
    });
  });
  ...
  describe('An N3Store with the http prefix', function() {
    ...
    describe('should allow to query subjects without prefixes', function() {
      it('should return all triples with that subject', shouldIncludeAll(store.find('http://foo.org/#s1', null, null), ['http://foo.org/#s1', 'http://bar.org/p1', 'http://foo.org/#o1'], ['http://foo.org/#s1', 'http://bar.org/p2', 'http://foo.org/#o1']));
    });
  });
  describe('An N3Store created without triples but with prefixes', function() {
    ...
    describe('should allow to query predicates with prefixes', function() {
      it('should return all triples with that predicate', shouldIncludeAll(store.find(null, 'http:b', null), ['a', 'http://www.w3.org/2006/http#b', 'c']));
    });
  });
  describe('An N3Store', function() {
    ...
    it('should be able to contain entities with JavaScript object property names', function() {
      ...
      shouldIncludeAll(store.find(null, null, null, 'hasOwnProperty'), ['toString', 'valueOf', 'toLocaleString', 'hasOwnProperty'])();
    });
